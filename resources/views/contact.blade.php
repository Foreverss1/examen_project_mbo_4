...
<body class="font-sans antialiased  text-black">
    <div class="bg-gray-50 text-black/50 bg-gray-700">
        ...
        <div class="relative min-h-screen flex flex-col items-center   selection:text-black">
            ...
            <h1 class="text-2xl font-semibold  mt-6">Contact Us</h1>
            <form action="{{ route('contact.submit') }}" method="POST" class="mt-4 w-1/4 max-w-lg">
                @csrf
                <div class="mb-4">
